...
class ModelResponse(BaseModel):
    ...
    context_window: int | None = Field(default=None, description="Maximum input context window in tokens when configured")


def _resolve_context_window_from_model_extra(model) -> int | None:
    extra = getattr(model, "model_extra", None)
    if not isinstance(extra, dict):
        return None
    value = extra.get("context_window") or extra.get("max_input_tokens")
